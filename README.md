...
> 扩展临期风险队列：商标进入续展期、宽展期或即将错过办理窗口时，服务生成紧急程度、滞纳金、最晚提交日和需要补齐的材料，代理人列表按风险排序，客户也能收到对应提醒。
> 扩展补正材料版本：官方要求补正委托书、主体资格、类别说明或中文译名时，接口保存每次上传版本、提交时间、处理人和被替换原因；历史文件不能被新附件直接覆盖。
